...
from models import ResNet34, SimpleCnn, SimpleCnn2, SimpleDilatedCnn
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--lr_min", default=0.03, type=float)
    argparser.add_argument("--lr_max", default=0.03, type=float)
