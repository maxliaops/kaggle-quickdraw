...
if __name__ == "__main__":
    ...
    argparser.add_argument("--batch_iterations", default=8, type=int)
    ...
    argparser.add_argument("--bootstraping_loss_ratio", default=0.6, type=float)
    ...
    argparser.add_argument("--sgdr_cycle_epochs_mult", default=1.2, type=float)
